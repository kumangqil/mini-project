...
st.image(r'C:\Users\Dell\Downloads\Data Analytics\gambar.jpeg')
st.title("Global Poverty & Economic Inequality Dashboard")

# 2. Load Data
df = pd.read_csv(r"C:\Users\Dell\Downloads\Data Analytics\global_poverty_economic_inequality.csv")
